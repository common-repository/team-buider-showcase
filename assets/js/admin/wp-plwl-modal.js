...
(function( $, plwl ){
    ...
    var plwlModal = Backbone.Model.extend( {
        ...
        initialize: function( args ){
            ...
            var modalView = new plwl.modal['view']({
                'model': this,
            ...
            this.set( 'plwlModal', modalView );

        },

        open: function( $item ) {
            var wpMediaView = this.get( 'wpMediaView' ),
                plwlModal = this.get( 'plwlModal' );

            // Set the current item
            this.set( 'item', $item );
            // Render TeamBuilderShowcase View
            plwlModal.render();
            // Append plwlModalView to wpMediaView
            wpMediaView.content( plwlModal );
            // Open wpMediaView
            wpMediaView.open();
    ...
    var plwlModalView = Backbone.View.extend( {

        /**
        * The Tag Name and Tag's Class(es)
        */
        tagName:    'div',
        className:  'edit-attachment-frame mode-select hide-menu hide-router plwl-edit-popup',

        /**
        * Template
        * - The template to load inside the above tagName element
        */
        template:   wp.template( 'plwl-image-editor' ),
        ...
        */
        events: {
            ...
            'click .actions a.plwl-team-builder-showcase-meta-submit':       'saveItem',
            'click .actions a.plwl-team-builder-showcase-meta-submit-close': 'saveItemAndClose',
        ...
        * Initialize
        *
        * @param object model   TeamBuilderShowcaseImage Backbone Model
        */
        initialize: function( args ) {
        ...
        */
        render: function() {
            ...
            // Get current Index.
            this.attachment_index = plwl.Items.indexOf( this.item );
            ...
            if ( this.attachment_index == ( plwl.Items.length - 1 ) ) {
        ...
        * wp.media.view.TeamBuilderShowcaseGalleryError
        */
        renderError: function( error ) {
            ...
            // Define view
            var view = new wp.media.view.TeamBuilderShowcaseGalleryError( {
                model: model
            } );
        ...
        */
        loadPreviousItem: function() {
            ...
            item = plwl.Items.at( this.attachment_index );
        ...
        */
        saveItem: function( event ) {
            ...
            wp.TeamBuilderShowcase.Save.saveImage( item.get( 'id' ), function(){
        ...
        saveItemAndClose: function ( event ){
            ...
            clearInterval( wp.TeamBuilderShowcase.Save.updateInterval );
            wp.TeamBuilderShowcase.Save.saveImages( function(){
                // Get item view and render it.
